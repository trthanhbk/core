...
<html lang="en">
    ...
    <body class="skin-blue sidebar-mini">
        <div class="wrapper">
            @include("themes.adminlte.layouts.navigation")
            ...
            <footer class="main-footer">
                <strong>&copy; {!! date('Y'); !!} <a href="http://portalbeanzvn.com/" target="_blank">Stater Template</a> by Portal Beanz Viet Nam</strong>
            </footer>
        </div>
